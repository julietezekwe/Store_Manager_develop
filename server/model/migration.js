...
pool.query('CREATE TABLE IF NOT EXISTS Sales(id SERIAL PRIMARY KEY, sellerId INTEGER not null, productId INTEGER not null,  ProductName VARCHAR(100) not null, prize INTEGER not null, quantity INTEGER not null, totalPrize INTEGER not null, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)');
